...
const NAICS_KEYWORD_MAP: Record<string, KeywordEntry[]> = {
    ...
    "484110": [
        { keywords: ["freight trucking", "trucking company", "trucking services"], weight: 3 },
        { keywords: ["local freight", "local trucking", "local delivery"], weight: 3 },
        { keywords: ["delivery services", "hauling", "hauling services"], weight: 2 },
        { keywords: ["truck fleet", "fleet trucking", "cdl driver", "commercial driver"], weight: 2 },
        { keywords: ["flatbed", "dry van", "box truck"], weight: 2 },
        { keywords: ["freight carrier", "motor carrier"], weight: 3 },
    ],
    "484121": [
        { keywords: ["long distance trucking", "long haul", "long-haul"], weight: 3 },
        { keywords: ["over-the-road", "otr trucking", "otr driver"], weight: 3 },
        { keywords: ["interstate freight", "cross-country freight", "national freight"], weight: 2 },
        { keywords: ["truckload", "full truckload", "ftl"], weight: 3 },
    ],
    "484122": [
        { keywords: ["less than truckload", "ltl", "ltl freight"], weight: 3 },
        { keywords: ["partial load", "consolidated freight"], weight: 3 },
        { keywords: ["ltl carrier", "ltl shipping"], weight: 2 },
    ],
    "488510": [
        { keywords: ["freight forwarding", "freight forwarder"], weight: 3 },
        { keywords: ["customs broker", "customs brokerage", "customs clearance"], weight: 3 },
        { keywords: ["freight broker", "freight brokerage"], weight: 3 },
        { keywords: ["third-party logistics", "3pl", "third party logistics"], weight: 3 },
        { keywords: ["logistics provider", "logistics services", "logistics company", "logistics solutions"], weight: 3 },
        { keywords: ["supply chain", "supply chain services", "supply chain management"], weight: 2 },
        { keywords: ["shipping services", "freight services", "freight management"], weight: 2 },
        { keywords: ["logistics", "logistic"], weight: 2 },
        { keywords: ["transportation management", "transport services", "transportation services"], weight: 2 },
    ...
    "492110": [
        ...
        { keywords: ["express delivery", "same-day delivery", "next-day delivery"], weight: 3 },
        { keywords: ["messenger service", "parcel delivery", "package delivery"], weight: 2 },
        { keywords: ["last mile delivery", "last-mile", "final mile"], weight: 2 },
    ],
    "488490": [
        { keywords: ["moving services", "moving company", "movers"], weight: 3 },
        { keywords: ["relocation services", "household moving", "corporate relocation"], weight: 3 },
        { keywords: ["freight packing", "crating services", "packing services"], weight: 2 },
    ],
    "488190": [
        { keywords: ["air cargo", "air freight"], weight: 3 },
        { keywords: ["airport services", "ground handling"], weight: 3 },
        { keywords: ["aircraft maintenance", "aviation services"], weight: 2 },
    ],
    "811310": [
