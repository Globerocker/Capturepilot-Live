...
const STATES = ["VA", "MD", "DC", "TX", "CA", "FL", "NY"];
const CERTS = ["8A", "HUBZone", "SDVOSB", "WOSB", "EDWOSB"];
...
export default function ContractorsPage() {
    ...
    const fetchContractors = useCallback(async () => {
        ...
        try {
            ...
            // Apply Tab Filter
            if (activeTab === "sam") {
                query = query.is("sam_registered", true); // Handle true or null as true if needed, but explicit is better
            } else {
    ...
    }, [page, activeSearch, activeTab, pageSize, filterState, filterNaics, filterCert]);

    useEffect(() => {
        fetchContractors();
    }, [fetchContractors, filterState, filterNaics, filterCert]);
