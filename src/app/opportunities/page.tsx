...
export default function OpportunitiesPage() {
    ...
    }, [page, activeSearch, quickFilter, pageSize, filterAgency, filterType, filterNaics]);

    useEffect(() => {
        fetchOpportunities();
    }, [fetchOpportunities, filterAgency, filterType, filterNaics]);
    ...
    return (
        <div className="flex h-full gap-6 max-w-[1600px] mx-auto pb-12 overflow-hidden">
            {/* Main Content Area */}
            <div className={clsx("transition-all duration-500 ease-in-out flex-1 flex flex-col h-full", selectedOpportunity ? "hidden lg:flex lg:w-1/2 xl:w-2/3" : "w-full")}>
                    ...
                    <div className="overflow-y-auto flex-1 p-6 custom-scrollbar space-y-8">
                        ...
                        <div className="bg-stone-900 text-white rounded-[32px] p-6 shadow-md relative overflow-hidden">
                            ...
                            <div className="space-y-3 mb-5">
                                ...
                                <div className="flex justify-between items-center bg-black/40 px-4 py-2 rounded-xl text-sm border border-stone-700/50">
                                    ...
                                    <span className="font-bold">{selectedOpportunity.set_aside_code || "Unrestricted"}</span>
                                </div>
                            </div>
                            <p className="text-sm text-stone-300 font-sans leading-relaxed">
                                Our semantic engine indicates {selectedOpportunity.agency || "the agency"} is actively scouting for qualified vendors under NAICS {selectedOpportunity.naics_code}. Priority status favors entities matching the {selectedOpportunity.set_aside_code || 'Unrestricted'} classification.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="bg-stone-50 border border-stone-200 p-4 rounded-2xl">
                                ...
                                <p className="font-typewriter font-bold text-xs uppercase pt-1 line-clamp-1" title={selectedOpportunity.set_aside_code || "NONE"}>
                                    {selectedOpportunity.set_aside_code || "NONE"}
                                </p>
                            </div>
                            <div className="bg-stone-50 border border-stone-200 p-4 rounded-2xl">
